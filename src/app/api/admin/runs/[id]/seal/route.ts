...
import { SealSimulationRunService } from '../../../../../../application/services/SealSimulationRunService';
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    InMemoryProductionRateLimiter.consume(actor.id, `POST_ADMIN_RUNS_SEAL`);
    ...
    const run = await SealSimulationRunService.execute(id, parsed.version, parsed.expectedStatus, parsed, actor);
