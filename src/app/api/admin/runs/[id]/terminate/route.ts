...
import { TerminateSimulationRunService } from '../../../../../../application/services/TerminateSimulationRunService';
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    InMemoryProductionRateLimiter.consume(actor.id, `POST_ADMIN_RUNS_TERMINATE`);
    ...
    const run = await TerminateSimulationRunService.execute(id, parsed.version, parsed.expectedStatus, parsed, actor);
