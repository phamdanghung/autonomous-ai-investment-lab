...
import { ResumeSimulationRunService } from '../../../../../../application/services/ResumeSimulationRunService';
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    InMemoryProductionRateLimiter.consume(actor.id, `POST_ADMIN_RUNS_RESUME`);
    ...
    const run = await ResumeSimulationRunService.execute(id, parsed.version, parsed, actor);
