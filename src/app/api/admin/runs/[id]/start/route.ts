...
import { StartSimulationRunService } from '../../../../../../application/services/StartSimulationRunService';
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    InMemoryProductionRateLimiter.consume(actor.id, `POST_ADMIN_RUNS_START`);
    ...
    const run = await StartSimulationRunService.execute(id, parsed.version, parsed, actor);
